...
public class TestJavassistCodegen {
   ...
   public void testCodegen() throws Exception {
      ...
      Assert.assertTrue("",
         Files.isRegularFile(base.resolve("HikariProxyCallableStatement.class")));
      Assert.assertTrue("",
         Files.isRegularFile(base.resolve("HikariProxyPreparedStatement.class")));
      ...
      int mod = fauxClassLoader.loadClass("com.zaxxer.hikari.pool.HikariProxyConnection")
         .getModifiers();
   ...
   private Method getMethod(Class<?> clazz, String methodName, Integer... parameterCount) {
      return Stream.of(clazz.getDeclaredMethods())
         ...
         .filter(method -> (parameterCount.length == 0
            || parameterCount[0] == method.getParameterCount()))
