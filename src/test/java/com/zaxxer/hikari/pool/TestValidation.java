...
public class TestValidation {
   ...
   public void validateMissingDS() {
      try {
         ...
         assertTrue(
            ise.getMessage().contains("dataSource or dataSourceClassName or jdbcUrl is required."));
      }
   }
   ...
   public void validateIdleTimeoutExceedsLifetime() {
      ...
      assertTrue("idleTimeout is close to or more than maxLifetime, disabling it." + s + "*",
         s.contains("is close to or more than maxLifetime"));
   }
